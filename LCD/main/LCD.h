...
void lcd_draw_char(uint16_t *buffer, int x, int y, char c, uint16_t color);
void lcd_draw_string(uint16_t *buffer, int x, int y, const char *str, uint16_t color);
void lcd_draw_int32(uint16_t *buffer, int x, int y, long int value, uint16_t color);
void lcd_clear_buffer(uint16_t *buffer, uint16_t color);
